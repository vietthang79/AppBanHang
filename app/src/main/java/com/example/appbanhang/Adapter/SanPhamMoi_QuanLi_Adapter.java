...
public class SanPhamMoi_QuanLi_Adapter extends RecyclerView.Adapter<SanPhamMoi_QuanLi_Adapter.MyViewHolder> {

    Context context;
    List<SanPhamMoi> array;

    public SanPhamMoi_QuanLi_Adapter(Context context, List<SanPhamMoi> array) {
