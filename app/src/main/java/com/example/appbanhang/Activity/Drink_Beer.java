...
import com.example.appbanhang.Adapter.DrinkAdapter;
...
public class Drink_Beer extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drink_beer);
    ...
    private void loadMore() {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                adapterDrink.notifyItemInserted(sanPhamMoiList.size()-1);
            }
        });
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                adapterDrink.notifyItemRemoved(sanPhamMoiList.size());
                page = page +1;
                getData(page);
                        ...
                        sanPhamMoiModel -> {
                            if (sanPhamMoiModel.isSuccess()){
                                if (adapterDrink == null){
                                    ...
                                    adapterDrink = new DrinkAdapter(getApplicationContext(), sanPhamMoiList);
                                    ...
                                    adapterDrink.notifyItemRangeInserted(vitri, soluongadd);
                                }
    ...
    protected void onStart() {
        ...
        FancyToast.makeText(Drink_Beer.this,"CONNECTION FAIL",FancyToast.LENGTH_LONG,FancyToast.ERROR,true).show();
    ...
    protected void onStop() {
        ...
        FancyToast.makeText(Drink_Beer.this,"CONNECTION SUCCESS",FancyToast.LENGTH_LONG,FancyToast.SUCCESS,true).show();
        super.onStop();
    }
}