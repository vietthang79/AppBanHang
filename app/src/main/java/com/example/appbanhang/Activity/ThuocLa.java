...
public class ThuocLa extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FancyToast.makeText(ThuocLa.this,"CONNECTION FAIL",FancyToast.LENGTH_LONG,FancyToast.ERROR,true).show();
    ...
    protected void onStop() {
        ...
        FancyToast.makeText(ThuocLa.this,"CONNECTION SUCCESS",FancyToast.LENGTH_LONG,FancyToast.SUCCESS,true).show();
        super.onStop();
    }
}