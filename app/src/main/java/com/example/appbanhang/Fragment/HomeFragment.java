...
//            getListPhoto();
            ...
            Toast.makeText(getActivity(),"Không có internet, vui lòng kết nối", Toast.LENGTH_SHORT).show();
        }
        setViewPager();
    ...
    private void getSpMoi() {
        compositeDisposable.add(apiBanHang.getSpMoi()
                ...
                .subscribe(
                        ...
                        throwable -> {
                            Toast.makeText(getContext(), "Không kết nối được sever"+throwable.getMessage(), Toast.LENGTH_SHORT).show();
                        }
